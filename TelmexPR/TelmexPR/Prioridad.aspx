<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prioridad.aspx.cs" Inherits="TelmexPR.Prioridad" %>
...
&nbsp;<span class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></td>
            ...
            <tr>
                <td align="center" class="auto-style3">IMPORTAR LISTADO DE PRIORIDAD</td>
            </tr>
            <tr>
                ...
                <td align="center" class="auto-style3">
                    <asp:Panel ID="Panel1" runat="server" style="text-align: left">
                        <table class="auto-style1">
                            ...
                            <tr>
                                <td class="auto-style5" colspan="3">Buscar:&nbsp;
                            ...
                            <tr>
                                <td class="auto-style5" colspan="3">
                                    <asp:Panel ID="PnGrid" runat="server">
                                        <asp:GridView ID="gvPrioridad" runat="server" CellPadding="4" Font-Size="X-Small" ForeColor="#333333">
