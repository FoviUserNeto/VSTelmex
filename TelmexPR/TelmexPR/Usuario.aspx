<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Usuario.aspx.cs" Inherits="TelmexPR.Usuario" %>
    ...
    <form id="form1" runat="server">
       ...
       <article>
        ...
        <table class="auto-style1">
            <tr>
                <td colspan="2" style="text-align: center">LISTADO DE USUARIOS</td>
            </tr>
            <tr>
                    ...
                    <asp:Panel ID="PnGuardar" runat="server">
                        ...
                        <table class="auto-style1">
                            ...
                            <tr>
                                ...
                                <td class="auto-style13">
                                    <asp:TextBox ID="txtCargo" runat="server" style="margin-bottom: 1px" Width="250px"></asp:TextBox>
                                </td>
                                <td>&nbsp; &nbsp; &nbsp; &nbsp; </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style13">
                                    <asp:TextBox ID="txtUsuario" runat="server" style="margin-bottom: 1px" Width="250px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style13">
                                    <asp:TextBox ID="txtContrasena" runat="server" style="margin-bottom: 1px" Width="250px" TextMode="Password"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtContrasena" ControlToValidate="txtRepetir" ErrorMessage="Las contaseñas no coinciden" ForeColor="Blue"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style11">
                                ...
                                <td class="auto-style13">
                                    <asp:TextBox ID="txtRepetir" runat="server" style="margin-bottom: 1px" Width="250px" TextMode="Password">Vuelva escribir la contraseña</asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
